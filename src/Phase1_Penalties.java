public class Phase1_Penalties {
	...
	private final int reserveDivisionParam;
	...
	public int getReserveDivisionParam() {
		return reserveDivisionParam;
	}
}
